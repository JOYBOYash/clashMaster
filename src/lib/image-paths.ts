...
const itemImageMap: Record<string, string> = {
  ...
  'Giant Gauntlet': '/assets/_hero_equipment/bk/giant-gauntlet.png',
  'Snake Bracelet': '/assets/_hero_equipment/bk/snake-bracelet.png',
  ...
  'Fireball': '/assets/_hero_equipment/gw/fireball.png',
  'Life Gem': '/assets/_hero_equipment/gw/life-gem.png',
  'Rage Gem': '/assets/_hero_equipment/gw/rage-gem.png',
  'Lavaloon Puppet': '/assets/_hero_equipment/gw/lavaloon-puppet.png',
  'Healing Tome': '/assets/_hero_equipment/gw/healing-tome.png',
  'Dark Crown': '/assets/_hero_equipment/gw/dark-crown.png',
  'Henchmen Puppet': '/assets/_hero_equipment/gw/henchman.png',
  'Metal Pants': '/assets/_hero_equipment/gw/iron-pants.png',
  'Power Pump': '/assets/_hero_equipment/gw/power-pump.png',
  'Dark Orb': '/assets/_hero_equipment/gw/dark-orb.png',
  ...
  // Siege Machines
  'Wall Wrecker': '/assets/_siege_machines/wall-wrecker.png',
  'Battle Blimp': '/assets/_siege_machines/battle-blimp.png',
  'Stone Slammer': '/assets/_siege_machines/stone-slammer.png',
  'Siege Barracks': '/assets/_siege_machines/siege-barracks.png',
  'Log Launcher': '/assets/_siege_machines/log-launcher.png',
  'Troop Launcher': '/assets/_siege_machines/troop-launcher.png',
